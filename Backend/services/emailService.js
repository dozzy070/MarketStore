...
// 🔥 FORCE IPv4 for nodemailer's DNS resolution
...
// =====================
// Email transporter (Gmail SMTP with IPv4 forced)
// =====================
export const transporter = nodemailer.createTransport({
  ...
  lookup: ipv4Lookup,   // ← forces IPv4 resolution
});
...
export const sendWelcomeEmail = async (user) => {
  console.log('🔥🔥🔥 sendWelcomeEmail called for', user.email); // <-- added log
